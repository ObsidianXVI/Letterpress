    ...
    return ViewScaffold(
      child: Center(
        child: Container(
          ...
          child: Center(child: EmailSubscriptionDialog(isSubscribed: false)),
        ),
      ),
    );
  }
    ...
    : super(
        ...
        components: [
          ...
          LPText.plainBody(
            ...
            leftSideNotes: [LPSideNoteComment(text: "Hello", leftSide: true)],
          ),
          LPTextSpan(
            lpTextComponents: [
    ...
    : super(
        ...
        components: [
          ...
          LPText.header1(
            content: "Designing",
            leftSideNotes: [
              LPSideNoteComment(text: "Hello there!", leftSide: true),
            ],
          ),
          ...
          LPTextSpan(
            lpTextComponents: [
              ...
              LPText.plainBody(
                content: " event. While a method of reading and converting ",
              ),
              LPText.codeStyle(content: "ical", inline: true),
