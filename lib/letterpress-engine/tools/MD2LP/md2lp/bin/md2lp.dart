...
final String src = """Openly open-source
I have worked on many personal projects before, and they're sitting on my GitHub as public repos with GPLv3 licenses. If that counts as open-source, then consider me a professional [open-sourcer](https://github.com/drknzz/GitHub-Achievements/blob/main/Media/Badges/Open-Sourcerer/PNG/OpenSourcerer.png).
...
# When the Goalpost Keeps Shifting

Now, for those acquainted with my [previous articles](https://letterpress-project.web.app/#/blogules/perfekshun), you would know that I struggle to rein in the perfectionist in me. Turning an already public repo into an open-source project shouldn't be that tough right? Well, you'll be surprised at how I've managed to turn it into rocket science and a week-long endeavour.

[observe](https://en.meming.world/images/en/thumb/0/0d/Larry_the_Lobster_%22Observe%22.jpg/600px-Larry_the_Lobster_%22Observe%22.jpg)
...
[IMAGE](https://i.redd.it/zsmfa93b0tjd1.jpeg)
From (https://www.reddit.com/r/ProgrammerHumor/comments/1ewt16f/multithreadingiseasy/?utm_source=share&utm_medium=web3x&utm_name=web3xcss&utm_term=1&utm_content=share_button)

Thread 1 is community-related tasks, which includes community engagement items. "LP", for instance, refers to this blog, Letterpress. I needed to add "new changes" such as the ability to subscribe to email notifications and to send anonymous analytics about which articles were clicking. After that, I could write and publish a few articles about my experience with going open source and then Letterpress would be fully ready to face the world. I was hoping that at the same time as I was promoting the Affogato Project on Reddit, I could also spread the word about Letterpress, in which case I would need to have at least a few really good articles that would interest visitors.

The second thread relates to the actual features I need to add on before releasing even v0.0.1 to pub.dev. I even considered writing some tests, but didn't since [real men test in production](https://youtu.be/H9RSeDUdkCA?si=c0zjVdBTTeyAiHXG). Maybe there's a chance that quite possibly, at some time in the future, I might consider 100% test coverage. But for now, I've decided that I won't be accepting contributions as yet. I'm really swamped with a lot of work not just in the Affogato Project, but also in other projects, and the headache of documentation, writing tests, reviewing PRs and building CI/CD pipelines is something I don't need right now. So I'm just sticking to the good ol' it-seems-alright-testing.
