  ...
  Openly_Open_Source({
    ...
    required bool isPreviewMode,
          ...
          components: [
            ...
            LPText.header1(
              content: "Introduction to Affogato",
            ),
            LPText.plainBody(
                content:
            ...
            LPText.header1(
              content: "When the Goalpost Keeps Shifting",
            ),
            LPTextSpan(
              lpTextComponents: [
                LPText.plainBody(
                  content: "Now, for those acquainted with my ",
                ),
                LPText.hyperlink(
            ...
            const LPCodeBlock(content: """Thread 1 (community)
